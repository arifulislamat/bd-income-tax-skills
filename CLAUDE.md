...
- All tax math goes through `skills/bd-income-tax/scripts/tax_calc.py` — never hand-calculate.
- Run `python3 skills/bd-income-tax/scripts/tax_calc.py --selftest` before committing.
